...
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=SGDRegressor(alpha=0.0, eta0=0.01, fit_intercept=True, l1_ratio=1.0, learning_rate="constant", loss="squared_loss", penalty="elasticnet", power_t=50.0)),
    MaxAbsScaler(),
    MaxAbsScaler(),

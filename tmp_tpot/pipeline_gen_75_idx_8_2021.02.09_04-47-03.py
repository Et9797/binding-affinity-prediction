...
# Average CV score on the training set was: -3.390305519908013
exported_pipeline = make_pipeline(
    ...
    SelectFromModel(estimator=ExtraTreesRegressor(max_features=0.7000000000000001, n_estimators=100), threshold=1.0),
    RidgeCV()
)

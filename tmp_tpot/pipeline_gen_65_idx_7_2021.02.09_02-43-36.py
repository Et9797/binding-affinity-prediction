...
# Average CV score on the training set was: -3.38923565616812
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVR(C=0.001, dual=True, epsilon=1.0, loss="squared_epsilon_insensitive", tol=0.1)),
    RidgeCV()
)

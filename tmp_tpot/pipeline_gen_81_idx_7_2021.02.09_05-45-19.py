...
# Average CV score on the training set was: -3.381460593320645
exported_pipeline = make_pipeline(
    ...
    MinMaxScaler(),
    StackingEstimator(estimator=SGDRegressor(alpha=0.01, eta0=0.01, fit_intercept=False, l1_ratio=0.5, learning_rate="constant", loss="huber", penalty="elasticnet", power_t=0.0)),
    ...
    StackingEstimator(estimator=LinearSVR(C=20.0, dual=True, epsilon=0.001, loss="epsilon_insensitive", tol=0.1)),
    RidgeCV()
)

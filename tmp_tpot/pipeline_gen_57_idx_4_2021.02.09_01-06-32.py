...
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVR(C=1.0, dual=True, epsilon=1.0, loss="squared_epsilon_insensitive", tol=0.1)),
    ...
    StackingEstimator(estimator=LinearSVR(C=10.0, dual=True, epsilon=0.01, loss="squared_epsilon_insensitive", tol=1e-05)),
    ZeroCount(),

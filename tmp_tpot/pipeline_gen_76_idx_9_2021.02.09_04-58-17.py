...
# Average CV score on the training set was: -3.3664446808117288
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVR(C=25.0, dual=True, epsilon=0.01, loss="epsilon_insensitive", tol=1e-05)),
    FeatureAgglomeration(affinity="l2", linkage="average"),
    SelectPercentile(score_func=f_regression, percentile=6),
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=True, max_features=0.8, min_samples_leaf=19, min_samples_split=10, n_estimators=400)),

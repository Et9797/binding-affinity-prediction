...
# Average CV score on the training set was: -3.3004290360557693
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVR(C=1.0, dual=True, epsilon=0.001, loss="squared_epsilon_insensitive", tol=1e-05)),
    RidgeCV()
)

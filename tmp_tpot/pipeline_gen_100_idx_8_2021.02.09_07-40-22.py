...
# Average CV score on the training set was: -3.324562372147199
exported_pipeline = make_pipeline(
    ...
    SelectPercentile(score_func=f_regression, percentile=92),
    StackingEstimator(estimator=DecisionTreeRegressor(max_depth=10, min_samples_leaf=16, min_samples_split=5)),

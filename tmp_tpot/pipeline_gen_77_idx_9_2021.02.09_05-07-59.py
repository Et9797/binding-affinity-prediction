...
# Average CV score on the training set was: -3.3626407007902532
exported_pipeline = make_pipeline(
    ...
    SelectPercentile(score_func=f_regression, percentile=92),
    SelectFromModel(estimator=ExtraTreesRegressor(max_features=0.3, n_estimators=10), threshold=0.4),

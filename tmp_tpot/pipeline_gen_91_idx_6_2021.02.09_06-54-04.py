...
# Average CV score on the training set was: -3.348912369745006
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVR(C=25.0, dual=True, epsilon=0.1, loss="epsilon_insensitive", tol=1e-05)),
    FeatureAgglomeration(affinity="l2", linkage="average"),
    SelectPercentile(score_func=f_regression, percentile=6),
    StackingEstimator(estimator=LinearSVR(C=0.0001, dual=True, epsilon=0.1, loss="squared_epsilon_insensitive", tol=0.1)),
    RidgeCV()
)

...
# Average CV score on the training set was: -3.384513221188101
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVR(C=25.0, dual=True, epsilon=0.01, loss="epsilon_insensitive", tol=0.1)),

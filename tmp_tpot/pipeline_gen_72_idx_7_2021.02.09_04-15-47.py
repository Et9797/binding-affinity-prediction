...
# Average CV score on the training set was: -3.4087591736339267
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=XGBRegressor(learning_rate=0.001, max_depth=3, min_child_weight=3, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.9500000000000001, verbosity=0)),
    MinMaxScaler(),
